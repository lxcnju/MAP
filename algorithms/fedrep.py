...
class FedRep():
    def __init__(
        ...
        # copy private layers: classifier
        self.private_models = {}
        for client in self.clients:
            self.private_models[client] = copy.deepcopy(model.classifier)
    ...
    def train(self):
        ...
        for r in range(1, self.args.max_round + 1):
            ...
            for client in sam_clients:
                ...
                state_dict = {
                    "classifier.{}".format(k): v for k, v in
                ...
                # update local model
                state_dict = local_model.classifier.state_dict()
